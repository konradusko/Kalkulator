...
window.addEventListener('click', (el) => {
    ...
    } else if (el.target.className == "button signButton" && el.target.textContent == "/" || el.target.className == "line") {
...
window.addEventListener('keydown', (el) => {
    ...
    } else if (el.key == "%" || el.key == "C" || el.key == "c" || el.key == "/" || el.key == "*" || el.key == "+" || el.key == "-") {
...
function operationalSigns(sign) {
    ...
    } else if (sign == "=" && bottomNumbers.innerHTML != "0" && bottomNumbers.innerHTML != "-" && topNumbers.innerHTML.length > 0  && block == false || isthereProcent == true &&sign == "=" && bottomNumbers.innerHTML != "0" && bottomNumbers.innerHTML != "-"   && block == false ) {
        //obliczanie wyniku
        let result;
...
function writeNumber(number) {
    ...
    if(number == "," && isThereComma == true && block == false &&bottomNumbers.innerHTML.charAt(bottomNumbers.innerHTML.length - 1) == '.' &&bottomNumbers.innerHTML.charAt(bottomNumbers.innerHTML.length - 2) == '0'){
        isThereComma = false;
