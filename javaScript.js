...
let afterSum = false; //po zsumowaniu zeby mozna bylo dalej operować
...
function operationalSigns(sign) {
    ...
    if (sign == "+" && bottomNumbers.innerHTML != 0 ) {
        choosenSign = " + ";
    } else if (sign == "-" && bottomNumbers.innerHTML != 0 ) {
        choosenSign = " - ";
    } else if (sign == "/" && bottomNumbers.innerHTML != 0 ) {
        choosenSign = " / ";
...
function writeNumber(number) {
    //wpisywanie numerów w dolnej linii
     if (number == "," && isthereProcent == true && isThereComma == true && bottomNumbers.innerHTML.charAt(bottomNumbers.innerHTML.length - 1) == ',' && bottomNumbers.innerHTML.charAt(bottomNumbers.innerHTML.length - 2) == '0') {
        isThereComma = false;
    ...
    } else if (number == "," && isThereComma == false  && bottomNumbers.innerHTML == "-"||number == "," && isThereComma == false  && bottomNumbers.innerHTML.charAt(bottomNumbers.innerHTML.length - 1) == '%') {
        isThereComma = true;
        tmpComma = true;
        bottomNumbers.innerHTML = bottomNumbers.innerHTML.concat("0,");
        //dodaje przecinek dokładnie to 0. po % 
        //ew dodaje 0. jak jest sam minus
    } else if (number == "," && isThereComma == false ) {
        //dodaje przecinek
        isThereComma = true;
        tmpComma = true;
        bottomNumbers.innerHTML = bottomNumbers.innerHTML.concat(",");
    } else if (number != "," && bottomNumbers.innerHTML == "0" ) {
    ...
    } else if (number == "," && bottomNumbers.innerHTML == "0."  && isThereComma == true) {
        bottomNumbers.innerHTML = "0";
        isThereComma = false;
